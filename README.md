...
흥미로운 자료나 웹 아티클을 찾고는 잊어버리지 않으셨나요?<br> Clip은 사용자가 직접 정의한 카테고리와 스크랩 타입 별로 콘텐츠를 분류하고 시각화합니다.<br> 지금 바로 나만의 디지털 스크랩 룸을 만들어보세요! <br><br>
<img width="800" height="550" alt="image" src="https://github.com/user-attachments/assets/48beaa61-f422-456e-afdb-1e8d1717fed2" />
